...
env.unwrapped.config["other_vehicles_type"] = "highway_env.vehicle.behavior.DLVehicle"
...
# 存储数据
np.save('speed_ttc_BC.npy', speed_dhw_pairs)
np.save('lane_change_dhw_BC.npy', lane_change_dhw)
